...
/**
 * Something in the pharmacy dispensary queue has changed.
 *
 ...
 */
class PharmacyQueueUpdated implements ShouldBroadcast
{
    ...
    public function broadcastOn(): array
    {
        ...
        return [new PrivateChannel('pharmacy-queue.'.$this->facilityId)];
    }
