...
class DskInventoryItemsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $items = [
            ...
            ['code' => 'INV-LAB-KIT-HIV', 'name' => 'HIV 1/2 Rapid Test Kit', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'test', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-LAB-KIT-MRDT', 'name' => 'Malaria Rapid Diagnostic Test Kit (mRDT)', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'test', 'reorder_level' => 100, 'current_stock' => 500],
            ['code' => 'INV-LAB-KIT-WIDAL', 'name' => 'Typhoid Widal Rapid Test Kit', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'test', 'reorder_level' => 30, 'current_stock' => 150],
            ['code' => 'INV-LAB-KIT-HPYLORI', 'name' => 'Helicobacter Pylori Antibody Test Kit', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'test', 'reorder_level' => 30, 'current_stock' => 100],
            ['code' => 'INV-LAB-TUBE-RED', 'name' => 'Red Top Plain Tube (Clot Activator)', 'category' => 'laboratory', 'subcategory' => 'consumables', 'unit' => 'piece', 'reorder_level' => 200, 'current_stock' => 1000],
            ['code' => 'INV-LAB-TUBE-PURPLE', 'name' => 'Purple Top Tube (EDTA K3)', 'category' => 'laboratory', 'subcategory' => 'consumables', 'unit' => 'piece', 'reorder_level' => 200, 'current_stock' => 1000],
            ['code' => 'INV-LAB-TUBE-ESR', 'name' => 'ESR Westergren Tube', 'category' => 'laboratory', 'subcategory' => 'consumables', 'unit' => 'piece', 'reorder_level' => 100, 'current_stock' => 500],
            ['code' => 'INV-LAB-STRIP-HB', 'name' => 'Hemoglobin Test Strips', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'strip', 'reorder_level' => 100, 'current_stock' => 500],
            ['code' => 'INV-LAB-STRIP-RBG', 'name' => 'Blood Glucose (RBG) Strips', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'strip', 'reorder_level' => 100, 'current_stock' => 500],
            ['code' => 'INV-LAB-CONT-URINE', 'name' => 'Sterile Urine Specimen Container 60 ml', 'category' => 'laboratory', 'subcategory' => 'consumables', 'unit' => 'piece', 'reorder_level' => 100, 'current_stock' => 500],
            ['code' => 'INV-LAB-CONT-STOOL', 'name' => 'Stool Specimen Container with Spoon', 'category' => 'laboratory', 'subcategory' => 'consumables', 'unit' => 'piece', 'reorder_level' => 50, 'current_stock' => 300],
            ['code' => 'INV-LAB-KIT-UPT', 'name' => 'Urine Pregnancy Test (UPT) Strips/Cassettes', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'test', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-LAB-SLIDES', 'name' => 'Microscope Glass Slides (Frosted End)', 'category' => 'laboratory', 'subcategory' => 'consumables', 'unit' => 'box', 'reorder_level' => 10, 'current_stock' => 50],
            ['code' => 'INV-LAB-GIEMSA', 'name' => 'Giemsa Stain Solution 500 ml', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'bottle', 'reorder_level' => 2, 'current_stock' => 10],
            ['code' => 'INV-LAB-KIT-VDRL', 'name' => 'Syphilis (VDRL / RPR) Test Kit', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'test', 'reorder_level' => 30, 'current_stock' => 150],
            ['code' => 'INV-LAB-HVS-SWAB', 'name' => 'High Vaginal Sterile Cotton Swab', 'category' => 'laboratory', 'subcategory' => 'consumables', 'unit' => 'piece', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-LAB-ABO-ANTISERA', 'name' => 'ABO Blood Grouping Antisera Kit (Anti-A, Anti-B, Anti-D)', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'bottle', 'reorder_level' => 2, 'current_stock' => 5],
            ['code' => 'INV-LAB-KIT-HBSAG', 'name' => 'Hepatitis B Surface Antigen (HBsAg) Kit', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'test', 'reorder_level' => 30, 'current_stock' => 100],
            ['code' => 'INV-LAB-STRIP-CHO', 'name' => 'Cholesterol Test Strips', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'strip', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-LAB-STRIP-URA', 'name' => 'Uric Acid Test Strips', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'strip', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-LAB-IMMERSION-OIL', 'name' => 'Microscope Immersion Oil Type A 100 ml', 'category' => 'laboratory', 'subcategory' => 'consumables', 'unit' => 'bottle', 'reorder_level' => 1, 'current_stock' => 5],

            // ===== MEDICAL CONSUMABLES =====
            ['code' => 'INV-CONS-SYR-2ML', 'name' => 'Syringe 2 ml with Needle 23G', 'category' => 'medical_consumable', 'subcategory' => 'syringes_needles', 'unit' => 'piece', 'reorder_level' => 500, 'current_stock' => 2000],
            ['code' => 'INV-CONS-SYR-10ML', 'name' => 'Syringe 10 ml with Needle 21G', 'category' => 'medical_consumable', 'subcategory' => 'syringes_needles', 'unit' => 'piece', 'reorder_level' => 300, 'current_stock' => 1500],
            ['code' => 'INV-CONS-SYR-5ML', 'name' => 'Syringe 5 ml with Needle 21G', 'category' => 'medical_consumable', 'subcategory' => 'syringes_needles', 'unit' => 'piece', 'reorder_level' => 400, 'current_stock' => 1500],
            ['code' => 'INV-CONS-CANN-22G', 'name' => 'IV Cannula 22G (Blue)', 'category' => 'medical_consumable', 'subcategory' => 'catheters_tubes', 'unit' => 'piece', 'reorder_level' => 100, 'current_stock' => 500],
            ['code' => 'INV-CONS-CANN-20G', 'name' => 'IV Cannula 20G (Pink)', 'category' => 'medical_consumable', 'subcategory' => 'catheters_tubes', 'unit' => 'piece', 'reorder_level' => 100, 'current_stock' => 500],
            ['code' => 'INV-CONS-CANN-24G', 'name' => 'IV Cannula 24G (Yellow - Paediatric)', 'category' => 'medical_consumable', 'subcategory' => 'catheters_tubes', 'unit' => 'piece', 'reorder_level' => 50, 'current_stock' => 300],
            ['code' => 'INV-CONS-CANN-18G', 'name' => 'IV Cannula 18G (Green)', 'category' => 'medical_consumable', 'subcategory' => 'catheters_tubes', 'unit' => 'piece', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-CONS-IV-SET', 'name' => 'IV Infusion Giving Set with Air Vent', 'category' => 'medical_consumable', 'subcategory' => 'catheters_tubes', 'unit' => 'piece', 'reorder_level' => 100, 'current_stock' => 500],
            ['code' => 'INV-CONS-SCALP-VEIN', 'name' => 'Scalp Vein Set (Butterfly) 23G', 'category' => 'medical_consumable', 'subcategory' => 'catheters_tubes', 'unit' => 'piece', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-CONS-LANCET', 'name' => 'Sterile Blood Lancet (Twist Top)', 'category' => 'medical_consumable', 'subcategory' => 'syringes_needles', 'unit' => 'piece', 'reorder_level' => 500, 'current_stock' => 2000],
            ['code' => 'INV-PPE-GLOVE-EXAM', 'name' => 'Nitrile Examination Gloves (Non-Sterile)', 'category' => 'medical_consumable', 'subcategory' => 'gloves_ppe', 'unit' => 'pair', 'reorder_level' => 500, 'current_stock' => 2000],
            ['code' => 'INV-PPE-GLOVE-SURG', 'name' => 'Latex Surgical Gloves (Sterile Powder-Free)', 'category' => 'medical_consumable', 'subcategory' => 'gloves_ppe', 'unit' => 'pair', 'reorder_level' => 200, 'current_stock' => 1000],

            // ===== PHARMACEUTICALS (link to formulary clinical catalog) =====
            ['code' => 'MED-PARA-500TAB', 'name' => 'Paracetamol 500 mg tablet', 'category' => 'pharmaceutical', 'subcategory' => 'analgesics', 'unit' => 'tablet', 'reorder_level' => 1000, 'current_stock' => 5000],
            ...
            ['code' => 'INV-LAB-EDTA-CAP', 'name' => 'EDTA Micro-Capillary Collection Tube', 'category' => 'medical_consumable', 'subcategory' => 'consumables', 'unit' => 'piece', 'reorder_level' => 200, 'current_stock' => 1000],
            ['code' => 'INV-LAB-VAC-NEEDLE', 'name' => 'Vacutainer Multi-Sample Needle 21G/22G', 'category' => 'medical_consumable', 'subcategory' => 'syringes_needles', 'unit' => 'piece', 'reorder_level' => 300, 'current_stock' => 1500],
            ['code' => 'INV-LAB-STRIP-URINE-DIP', 'name' => 'Urinalysis 10-Parameter Dipstick Strips (100s)', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'strip', 'reorder_level' => 200, 'current_stock' => 1000],
            ['code' => 'INV-LAB-STOOL-SPATULA', 'name' => 'Wooden Stool Sample Applicator Spatula', 'category' => 'medical_consumable', 'subcategory' => 'consumables', 'unit' => 'piece', 'reorder_level' => 100, 'current_stock' => 500],
            ['code' => 'INV-LAB-NS-WET-MOUNT', 'name' => 'Normal Saline 0.9% Solution 100 ml (Microscopy)', 'category' => 'medical_consumable', 'subcategory' => 'consumables', 'unit' => 'bottle', 'reorder_level' => 10, 'current_stock' => 50],
            ['code' => 'INV-LAB-KOH-SOL', 'name' => 'Potassium Hydroxide (KOH) 10% Solution 50 ml', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'bottle', 'reorder_level' => 5, 'current_stock' => 20],
            ['code' => 'INV-LAB-REAG-LIPID', 'name' => 'Lipid Profile Test Reagents (Cholesterol / Triglycerides)', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'test', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-LAB-REAG-CREAT', 'name' => 'Renal Function / Uric Acid Reagent Set', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'test', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-LAB-REAG-WIDAL', 'name' => 'Widal Febrile Antigen Agglutination Set (O, H, AH, BH)', 'category' => 'laboratory', 'subcategory' => 'reagents_kits', 'unit' => 'set', 'reorder_level' => 5, 'current_stock' => 20],

            // ===== ADDITIONAL MEDICAL CONSUMABLES =====
            ['code' => 'INV-CONS-GAUZE-4X4', 'name' => 'Sterile Gauze Swabs 4x4 (Pack of 5)', 'category' => 'medical_consumable', 'subcategory' => 'wound_care', 'unit' => 'piece', 'reorder_level' => 500, 'current_stock' => 2000],
            ['code' => 'INV-CONS-COTTON-SWAB', 'name' => 'Sterile Cotton Wool Swab Balls', 'category' => 'medical_consumable', 'subcategory' => 'wound_care', 'unit' => 'piece', 'reorder_level' => 500, 'current_stock' => 2000],
            ['code' => 'INV-CONS-COTTON-ROLL', 'name' => 'Absorbent Cotton Wool Roll 500 g', 'category' => 'medical_consumable', 'subcategory' => 'wound_care', 'unit' => 'roll', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-CONS-SPIRIT-PREP', 'name' => 'Surgical Methylated Spirit 70% 500 ml', 'category' => 'medical_consumable', 'subcategory' => 'consumables', 'unit' => 'bottle', 'reorder_level' => 10, 'current_stock' => 50],
            ['code' => 'INV-CONS-POVIDONE-IODINE', 'name' => 'Povidone Iodine Antiseptic Solution 10% 500 ml', 'category' => 'medical_consumable', 'subcategory' => 'wound_care', 'unit' => 'bottle', 'reorder_level' => 10, 'current_stock' => 50],
            ['code' => 'INV-CONS-TAPE-ZINC', 'name' => 'Zinc Oxide Adhesive Plaster Tape (5 cm x 5 m)', 'category' => 'medical_consumable', 'subcategory' => 'wound_care', 'unit' => 'roll', 'reorder_level' => 30, 'current_stock' => 100],
            ['code' => 'INV-CONS-BANDAGE-STERILE', 'name' => 'Sterile Conforming Bandage 10 cm', 'category' => 'medical_consumable', 'subcategory' => 'wound_care', 'unit' => 'piece', 'reorder_level' => 100, 'current_stock' => 500],
            ['code' => 'INV-CONS-SCALPEL-11', 'name' => 'Surgical Scalpel Blade No. 11', 'category' => 'medical_consumable', 'subcategory' => 'surgical', 'unit' => 'piece', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-CONS-SCALPEL-15', 'name' => 'Surgical Scalpel Blade No. 15', 'category' => 'medical_consumable', 'subcategory' => 'surgical', 'unit' => 'piece', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-CONS-LIDO-1PCT-AMP', 'name' => 'Lidocaine 1% Injection 2 ml Ampoule (Procedural Anaesthetic)', 'category' => 'medical_consumable', 'subcategory' => 'anaesthetics', 'unit' => 'ampoule', 'reorder_level' => 100, 'current_stock' => 500],
            ['code' => 'INV-CONS-SUTURE-SILK-30', 'name' => 'Sterile Suture Silk 3-0 with Curved Cutting Needle', 'category' => 'medical_consumable', 'subcategory' => 'surgical', 'unit' => 'piece', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-CONS-SUTURE-REMOVE-KIT', 'name' => 'Disposable Suture Removal Kit (Stitch Cutter + Forceps)', 'category' => 'medical_consumable', 'subcategory' => 'surgical', 'unit' => 'set', 'reorder_level' => 20, 'current_stock' => 100],
            ['code' => 'INV-CONS-DRAIN-WICK', 'name' => 'Surgical Corrugated Rubber Drain / Gauze Wick', 'category' => 'medical_consumable', 'subcategory' => 'surgical', 'unit' => 'piece', 'reorder_level' => 20, 'current_stock' => 100],
            ['code' => 'INV-CONS-NS-FLUSH-10ML', 'name' => 'Normal Saline 0.9% 10 ml Flush Syringe (Pre-Filled)', 'category' => 'medical_consumable', 'subcategory' => 'iv_fluids', 'unit' => 'piece', 'reorder_level' => 100, 'current_stock' => 500],
            ['code' => 'INV-CONS-TOURNIQUET', 'name' => 'Elastic Quick-Release Venipuncture Tourniquet', 'category' => 'medical_consumable', 'subcategory' => 'iv_therapy', 'unit' => 'piece', 'reorder_level' => 20, 'current_stock' => 100],
            ['code' => 'INV-CONS-TRANSP-DRESS', 'name' => 'IV Cannula Transparent Fixation Dressing with Pad', 'category' => 'medical_consumable', 'subcategory' => 'wound_care', 'unit' => 'piece', 'reorder_level' => 100, 'current_stock' => 500],
            ['code' => 'INV-CONS-BLOOD-GIVE-SET', 'name' => 'Blood Transfusion Giving Set with 200um Filter', 'category' => 'medical_consumable', 'subcategory' => 'iv_therapy', 'unit' => 'piece', 'reorder_level' => 20, 'current_stock' => 100],
            ['code' => 'INV-CONS-OXYGEN-MASK', 'name' => 'Simple Adult Oxygen Face Mask with Tubing', 'category' => 'medical_consumable', 'subcategory' => 'respiratory', 'unit' => 'piece', 'reorder_level' => 10, 'current_stock' => 50],
            ['code' => 'INV-CONS-MVA-SYRINGE', 'name' => 'Manual Vacuum Aspiration (MVA) Double-Valve 60 ml Syringe', 'category' => 'medical_consumable', 'subcategory' => 'surgical', 'unit' => 'piece', 'reorder_level' => 5, 'current_stock' => 20],
            ['code' => 'INV-CONS-MVA-CANNULA', 'name' => 'Flexible Karman MVA Cannula (6mm / 7mm / 8mm)', 'category' => 'medical_consumable', 'subcategory' => 'surgical', 'unit' => 'piece', 'reorder_level' => 10, 'current_stock' => 50],
            ['code' => 'INV-CONS-SPECULUM-DISP', 'name' => 'Disposable Vaginal Speculum (Cusco Medium)', 'category' => 'medical_consumable', 'subcategory' => 'surgical', 'unit' => 'piece', 'reorder_level' => 50, 'current_stock' => 200],
            ['code' => 'INV-CONS-IMPLANON-ROD', 'name' => 'Etonogestrel Contraceptive Implant (Implanon NXT)', 'category' => 'medical_consumable', 'subcategory' => 'maternal_health', 'unit' => 'piece', 'reorder_level' => 20, 'current_stock' => 100],
            ['code' => 'INV-CONS-NEB-MASK', 'name' => 'Paediatric / Adult Nebulizer Chamber with Face Mask & Tubing', 'category' => 'medical_consumable', 'subcategory' => 'respiratory', 'unit' => 'piece', 'reorder_level' => 20, 'current_stock' => 100],
            ['code' => 'INV-CONS-NEEDLE-21G', 'name' => 'Hypodermic Injection Needle 21G (Green)', 'category' => 'medical_consumable', 'subcategory' => 'syringes_needles', 'unit' => 'piece', 'reorder_level' => 500, 'current_stock' => 2000],
            ['code' => 'INV-CONS-NEEDLE-23G', 'name' => 'Hypodermic Injection Needle 23G (Blue)', 'category' => 'medical_consumable', 'subcategory' => 'syringes_needles', 'unit' => 'piece', 'reorder_level' => 500, 'current_stock' => 2000],
            ['code' => 'INV-CONS-NEEDLE-26G', 'name' => 'Hypodermic Fine Needle 26G (Brown - Subcutaneous/ID)', 'category' => 'medical_consumable', 'subcategory' => 'syringes_needles', 'unit' => 'piece', 'reorder_level' => 200, 'current_stock' => 1000],
            ['code' => 'INV-CONS-SYR-1ML', 'name' => 'Tuberculin / Insulin 1 ml Syringe with 29G Fixed Needle', 'category' => 'medical_consumable', 'subcategory' => 'syringes_needles', 'unit' => 'piece', 'reorder_level' => 200, 'current_stock' => 1000],

            // ===== RADIOLOGY SUPPLIES (stocked as medical_consumable) =====
            ['code' => 'INV-RAD-US-GEL', 'name' => 'Acoustic Ultrasound Transmission Gel 5000 ml Cubitainer', 'category' => 'medical_consumable', 'subcategory' => 'consumables', 'unit' => 'bottle', 'reorder_level' => 10, 'current_stock' => 50],
            ['code' => 'INV-RAD-PROBE-COVER', 'name' => 'Latex-Free Ultrasound Transducer Probe Sheath Cover', 'category' => 'medical_consumable', 'subcategory' => 'consumables', 'unit' => 'piece', 'reorder_level' => 100, 'current_stock' => 500],
        ];
