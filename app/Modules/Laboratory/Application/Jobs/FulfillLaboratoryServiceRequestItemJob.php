...
class FulfillLaboratoryServiceRequestItemJob implements ShouldQueue
{
    use Queueable;
    ...
    public function handle(
        ...
        CreateLaboratoryOrderUseCase $createOrder,
        ...
        try {
            $createOrder->execute(
                payload: [
                    ...
                    'lab_test_catalog_item_id' => $this->catalogItemId,
                    'test_name' => $itemName,
                    'test_code' => $itemCode,
