...
namespace App\Modules\Payer\Infrastructure\Repositories;

use App\Modules\Payer\Domain\Repositories\PayerContractRepositoryInterface;
use App\Modules\Payer\Infrastructure\Models\PayerContractModel;
use App\Modules\Platform\Domain\Services\FeatureFlagResolverInterface;
use App\Modules\Platform\Infrastructure\Support\PlatformScopeQueryApplier;
use Illuminate\Contracts\Pagination\LengthAwarePaginator;
use Illuminate\Database\Eloquent\Builder;

class EloquentPayerContractRepository implements PayerContractRepositoryInterface
{
    ...
    {
        $contract = new PayerContractModel;
    ...
    {
        $query = PayerContractModel::query();
    ...
    public function existsByContractCode(
        ...
        return PayerContractModel::query()
    ...
    public function search(
        ...
        $queryBuilder = PayerContractModel::query();
    ...
    private function toSearchResult(LengthAwarePaginator $paginator): array
    {
        return [
            'data' => array_map(
                static fn (PayerContractModel $contract): array => $contract->toArray(),
                $paginator->items(),
            ),
            'meta' => [
