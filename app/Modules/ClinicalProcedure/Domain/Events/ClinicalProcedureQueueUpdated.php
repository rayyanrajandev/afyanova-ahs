...
/**
 * Something in the clinical procedure room queue has changed.
 *
 ...
 */
class ClinicalProcedureQueueUpdated implements ShouldBroadcast
{
    ...
    public function broadcastOn(): array
    {
        ...
        return [new PrivateChannel('procedure-queue.'.$this->facilityId)];
    }
