...
/**
 * Something in the radiology workstation queue has changed.
 *
 ...
 */
class RadiologyQueueUpdated implements ShouldBroadcast
{
    ...
    public function broadcastOn(): array
    {
        ...
        return [new PrivateChannel('radiology-queue.'.$this->facilityId)];
    }
