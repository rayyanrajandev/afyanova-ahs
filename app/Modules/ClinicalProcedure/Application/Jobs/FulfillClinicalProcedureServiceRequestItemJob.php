...
namespace App\Modules\ClinicalProcedure\Application\Jobs;
...
class FulfillClinicalProcedureServiceRequestItemJob implements ShouldQueue
{
    use Queueable;
    ...
    public function __construct(
        ...
        private readonly ?string $encounterId = null,
    ) {}

    public function handle(
        ServiceRequestItemRepositoryInterface $itemRepository,
        CreateClinicalProcedureOrderUseCase $createOrder,
        ...
        try {
            $createOrder->execute(
                payload: [
                    ...
                    'clinical_procedure_catalog_item_id' => $this->catalogItemId,
                    'procedure_description' => $itemName,
